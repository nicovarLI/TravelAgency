<form x-show="show" id="airline-update-form" class="flex-col mx-auto w-1/2 justify-center">
    ...
    <div class="flex justify-center mt-2">
        ...
        <button @click="show = ! show; updadteAirline(airlineId)" type="button" class="flex justify-center rounded-full py-2 px-4 bg-blue-400 text-sm text-white hover:bg-white action:bg-red-500r hover:text-blue-500">
            Submit
        </button>
    </div>
</form>
