        ...
        <main class="max-w-lg w-1/2 mx-auto mt-4 bg-gray-100 p-6 rounded-xl border-gray-200">
            ...
            <form id="add-flight-form" @submit.prevent="triggerCreate">
                <div class="mb-6 mt-2">
                    ...
                    <label class="block mb-2 mt-2 uppercase font-bold text-xs text-gray-700" for="departure_at">Departure time</label>
                    <input type="datetime-local" id="departure-date" name="departure_at" class="px-2 border-gray-400 mb-2 border" required/>
                    <label class="block mb-2 uppercase font-bold text-xs text-gray-700" for="arrival_at">Arrival time</label>
