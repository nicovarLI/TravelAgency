<form x-show="show" id="flight-update-form" class="flex-col mx-auto w-1/2 justify-center">
    ...
    <div class="mb-6 mt-2 flex flex-col">
        ...
        <select class="mx-auto w-full" style="width: 100%" id="edit-airline-select" name="airline_id"></select>
        <span class="text-md pl-3 text-gray-500">Origin</span>
        <select class="mx-auto w-full" style="width: 100%" id="edit-origin-select" name="origin_city_id"></select>
        <span class="text-md pl-3 text-gray-500">Destination</span>
        <select class="mx-auto w-full" style="width: 100%" id="edit-destination-select" name="destination_city_id"></select>
