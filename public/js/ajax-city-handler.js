...
const deleteCity = (cityId) => {
    const page = currentPage();
    $.ajax({
        url: `/api/cities/${cityId}?page=${page}`,
        method: 'DELETE',
        cache: false,
        success:function(response)
        {
...
const loadTable = () => {
    ...
    $.ajax({
        ...
        success:function(response)
        {
            ...
            //let tableLinks = renderLinks(links);

            $('#table-body').html(renderTable(cities))
            //console.log(renderTable(cities))
