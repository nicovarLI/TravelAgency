<form x-show="show" id="cities-update-form" class="flex-col">
    ...
    <div class="flex justify-center mt-2">
        <button @click="show = ! show" type="button" class="flex mr-2 text-md justify-center rounded-full py-2 px-4 bg-blue-400 text-white hover:bg-white action:bg-red-500r hover:text-blue-500">
            ↩
        </button>
